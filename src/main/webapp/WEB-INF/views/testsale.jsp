				...
				<div id="container" class="">
					<div class="row">
						...
						<%-- <div class="c7">
							...
							<div class="row">
								<label for="product_name">Danh mục sản phẩm</label> <select
								...
								<form id="frmSale" id="frmSale"
								method="post" onsubmit="return false">
								<input id="command" value="add" hidden>
								<div id="forUpdate">
									<label for="sale_id">ID</label> <input type="number"
										id="sale_id" name="sale_name" class="form-control" disabled="disabled"><br>
								</div>
								<label for="sale_name">NAME</label> <input type="text" class="form-control"
									id="sale_name" name="sale_name" required="required"><br>
								<label for="sale_start">START DATE</label> <input type="date" class="form-control"
									id="sale_start" name="sale_start" required="required"><br>
								<label for="sale_end">END DATE</label> <input type="date" class="form-control"
									id="sale_end" name="sale_end" required="required"><br>
								</br> <label for="discount" required="required">DISCOUNT</label>
								<input type="number" id="discount" class="form-control" name="discount" min="1"
									max="100"><br> <label for="descriptions">DESCRIPTION</label><br>
								<textarea rows="5" cols="30" id="descriptions" class="form-control"
									...
									<div class="modal-dialog modal-lg" role="document">
										<div class="modal-content">
											<div class="modal-header">
												<h5 class="modal-title" id="largeModalLabel">Large
													Modal</h5>
												<table id="tbProduct"
